                                ...
                                <div class="card">
                                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div className="ProgressCircle">
                                            <CircularProgressbarWithChildren value={serverRes.CPU_Used}>
                            ...
                            <div class="col-md-4 mb-3 mb-sm-0">
                                <div class="card">
                                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div className="ProgressCircle">
                                            <CircularProgressbarWithChildren value={serverRes.Disk_Used_Percent}>
                            ...
                            <div class="col-md-4 mb-3 mb-sm-0">
                                <div class="card">
                                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div className="ProgressCircle">
                                            <CircularProgressbarWithChildren value={(serverRes.Disk_Free / serverRes.Disk_Total) * 100}>
                            ...
                            <div class="col-md-4 mb-3 mb-sm-0">
                                <div class="card">
                                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div className="ProgressCircle">
                                            <CircularProgressbarWithChildren value={serverRes.Memory_Used}>
                            ...
                            <div class="col-md-4 mb-3 mb-sm-0">
                                <div class="card">
                                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div className="ProgressCircle">
                                            <CircularProgressbarWithChildren value={serverRes.Network_Download_Speed}>
                            ...
                            <div class="col-md-4 mb-3 mb-sm-0">
                                <div class="card">
                                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div className="ProgressCircle">
                                            <CircularProgressbarWithChildren value={serverRes.Network_Upload_Speed}>
